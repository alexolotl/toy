      ...
      <div className="App">
        ...
        <video ref={vidref => this.video = vidref} style={{display: 'none'}} width="400" height="400" preload="true" autoPlay="true" loop playsInline>
          ...
          */}
            ...
            <source type="video/mp4" src="video.matkastella.top/aez-project/toyboy_compressed.mp4" />
            <source type="video/webm" src="video.matkastella.top/aez-project/toyboy_compressed.webm" />
        </video>
